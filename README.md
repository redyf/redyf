...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=cba6f7&size=35&center=true&vCenter=true&width=1000&lines=Hello,+My+Name+is+Mateus;I'm+20+years+old;I'm+from+Brazil;I'm+Studying+Computer+Science;Welcome!+:%29)](https://git.io/typing-svg)
...
### My main skills:
[![My Skills](https://skillicons.dev/icons?i=html,css,bootstrap,js,react,python,c,git,github,linux,neovim)](https://skillicons.dev)
### Studying at the moment:
[![My Skills](https://skillicons.dev/icons?i=js,nextjs,tailwind)](https://skillicons.dev)
</div>
